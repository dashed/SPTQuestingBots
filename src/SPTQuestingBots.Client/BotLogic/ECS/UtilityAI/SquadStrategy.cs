...
public abstract class SquadStrategy
{
    ...
    public virtual void Deactivate(SquadEntity squad)
    {
        ...
        LoggingController.LogDebug("[SquadStrategy] Deactivated squad " + squad.Id + " (activeCount=" + (_activeSquads.Count - 1) + ")");
