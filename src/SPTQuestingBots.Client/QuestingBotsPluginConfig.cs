...
namespace SPTQuestingBots
{
    ...
    public static class QuestingBotsPluginConfig
    {
        ...
        public static void BuildConfigOptions(ConfigFile Config)
        {
            ...
            int minDistanceAILimitNormal =
                ConfigController.Config.Debug.Enabled && ConfigController.Config.Debug.AllowZeroDistanceSleeping ? 0 : 50;
            int minDistanceAILimitQuesting =
                ConfigController.Config.Debug.Enabled && ConfigController.Config.Debug.AllowZeroDistanceSleeping ? 0 : 25;
