...
namespace SPTQuestingBots.Configuration
{
    public class QuestGenerationConfig
    {
        ...
        public float NavMeshSearchDistanceItem { get; set; } = 1.5f;

        [JsonProperty("navmesh_search_distance_zone")]
        public float NavMeshSearchDistanceZone { get; set; } = 1.5f;
        ...
        public float NavMeshSearchDistanceDoors { get; set; } = 0.75f;
