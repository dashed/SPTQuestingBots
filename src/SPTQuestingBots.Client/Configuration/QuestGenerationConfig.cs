...
namespace SPTQuestingBots.Configuration
{
    public class QuestGenerationConfig
    {
        ...
        public float NavMeshSearchDistanceItem { get; set; } = 2.5f;

        [JsonProperty("navmesh_search_distance_zone")]
        public float NavMeshSearchDistanceZone { get; set; } = 5f;

        [JsonProperty("navmesh_search_distance_spawn")]
        public float NavMeshSearchDistanceSpawn { get; set; } = 5f;
