...
| **Maturity** | v0.1.11 (early) | v1.6.0 (C# port with major enhancements) |
...
7. **Testing infrastructure**: QuestingBots has 230 unit tests and CI. Phobos has none, relying on manual testing and benchmarks.
